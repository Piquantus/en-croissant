export const en_US = {
    translation: {
        ...
        "Home.Card.AICoach.Title": "AI Coaching Mode",
        "Home.Card.AICoach.Desc":
            "Play against the engine with real-time coaching feedback",
        "Home.Card.AICoach.Button": "Start Coaching",
        ...
        "Settings.MoveHighlight.Desc":
            "Show hightlight for last move and check",
